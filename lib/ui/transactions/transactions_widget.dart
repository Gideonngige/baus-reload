          ...
          () {
            ...
            return ListView(
              ...
              children: [
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      colors: [
                        ...
                        kAppTheme.primaryColor.withValues(alpha: 0.8),
                      ],
                    ...
                    boxShadow: [
                      BoxShadow(
                        color: kAppTheme.primaryColor.withValues(alpha: 0.3),
                        blurRadius: 10,
                ...
                //             TextButton(
                //               onPressed: () {
                //                 // Navigate to dedicated all transactions screen
                //                 Get.to(() => AllTransactionsWidget(controller: controller));
                //               },
                //               child: Text(
                //                 'View All',
                //                 style: TextStyle(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        child: Obx(() {
          if (controller.isFetching.value && controller.transactions.isEmpty) {
            return const Center(
              child: Padding(
                padding: EdgeInsets.all(16),
                child: CircularProgressIndicator(),
